...
<body>
	<div class="header2">
		<p align="center">
			&ensp;<img class="logo_img" src="img/checkered12.png"
				style="width: 100px; height: 80px" align="middle"> 사람게시판 등록
		</p>

	</div>

	<div class="regi_form">
		<form id="regi_form_people"action="mydb" method="post">
			<section>
				<table>
					<tr>
						<td>제목:</td>
						<td><input type="text" name="title" style="width: 300px"
					...
					<tr>
						<td>나이대:</td>
						<td><input list="age" name="age" required> <datalist
								id="age">
								<option value='10대'>
					...
					<td></td>
						<td><div>
								<input type="text" name="location_name" required> <input
									type="hidden" name="location_x"> <input type="hidden"
									name="location_y">
								<button id="mapfinder" onclick="showbox()"
					...
					<tr>
						...
						<td><textarea name="detail" rows="10" cols="50"
								data-provide="typeahead"></textarea>
						<td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<input type="submit" class="btn btn-primary" value="등록"
								...
								name="command" value="register_people">
						</td>
						<td >
							<a href="main.jsp">
